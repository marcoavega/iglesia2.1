...
if ($_POST['r'] == 'capture-lessons-edit-question8'   && !isset($_POST['crud'])) {

	$qc = $qc_controller->get8($_POST['question8']);
	...
	if (empty($qc)) {
		...
		$template_qc = '
			...
			<form method="POST" class="">
				<div class="">
					<input type="text" placeholder="id_question8" value="%s" disabled required>
					<input type="hidden" name="id_question8" value="%s">
				</div>
				<div class="">
					<input type="text" name="question8" placeholder="Pregunta" value="%s" required>
				</div>
				<div class="">
				...
				<div class="p_25">
					...
					<input type="hidden" name="r" value="capture-lessons-edit-question8">
...
} else if ($_POST['r'] == 'capture-lessons-edit-question8'   && $_POST['crud'] == 'set') {
