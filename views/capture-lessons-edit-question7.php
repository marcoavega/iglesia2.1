...
if ($_POST['r'] == 'capture-lessons-edit-question7'   && !isset($_POST['crud'])) {

	$qc = $qc_controller->get7($_POST['question7']);
	...
	if (empty($qc)) {
		...
		$template_qc = '
			...
			<form method="POST" class="">
				<div class="">
					<input type="text" placeholder="id_question7" value="%s" disabled required>
					<input type="hidden" name="id_question7" value="%s">
				</div>
				<div class="">
					<input type="text" name="question7" placeholder="Pregunta" value="%s" required>
				</div>
				<div class="">
				...
				<div class="p_25">
					...
					<input type="hidden" name="r" value="capture-lessons-edit-question7">
...
} else if ($_POST['r'] == 'capture-lessons-edit-question7'   && $_POST['crud'] == 'set') {
