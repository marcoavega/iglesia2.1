...
if ($_POST['r'] == 'capture-lessons-edit-question1'   && !isset($_POST['crud'])) {

	$qc = $qc_controller->get1($_POST['question1']);
	...
	if (empty($qc)) {
		...
		$template_qc = '
			...
			<form method="POST" class="">
				<div class="">
					<input type="text" placeholder="id_question1" value="%s" disabled required>
					<input type="hidden" name="id_question1" value="%s">
				</div>
				<div class="">
					<input type="text" name="question1" placeholder="Pregunta" value="%s" required>
				</div>
				<div class="">
				...
				<div class="p_25">
					...
					<input type="hidden" name="r" value="capture-lessons-edit-question1">
...
} else if ($_POST['r'] == 'capture-lessons-edit-question1'   && $_POST['crud'] == 'set') {
