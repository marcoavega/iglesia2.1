...
if ($_POST['r'] == 'capture-lessons-edit-bquote8'   && !isset($_POST['crud'])) {

	$tbc = $tbc_controller->get8($_POST['id_bible_quote8']);
	...
	if (empty($tbc)) {
		...
		printf($template, $_POST['bible_quote8']);
	} else {
		...
		$template_tbc = '
			...
			<form method="POST" class="">
				<div class="">
					<input type="text" placeholder="id_bible_quote8" value="%s" disabled required>
					<input type="hidden" name="id_bible_quote8" value="%s">
				</div>
				<div class="">
					<input type="text" name="bible_quote8" placeholder="Objetivos" value="%s" required>
				</div>
				<div class="">
				...
				<div class="p_28">
					...
					<input type="hidden" name="r" value="capture-lessons-edit-bquote8">
...
} else if ($_POST['r'] == 'capture-lessons-edit-bquote8'   && $_POST['crud'] == 'set') {

	$save_tbc = array(
		'id_bible_quote8' =>  $_POST['id_bible_quote8'],
		'bible_quote8' =>  $_POST['bible_quote8'],
