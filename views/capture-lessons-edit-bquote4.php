...
if ($_POST['r'] == 'capture-lessons-edit-bquote4'   && !isset($_POST['crud'])) {

	$tbc = $tbc_controller->get4($_POST['id_bible_quote4']);
	...
	if (empty($tbc)) {
		...
		printf($template, $_POST['bible_quote4']);
	} else {
		...
		$template_tbc = '
			...
			<form method="POST" class="">
				<div class="">
					<input type="text" placeholder="id_bible_quote4" value="%s" disabled required>
					<input type="hidden" name="id_bible_quote4" value="%s">
				</div>
				<div class="">
					<input type="text" name="bible_quote4" placeholder="Objetivos" value="%s" required>
				</div>
				<div class="">
				...
				<div class="p_25">
					...
					<input type="hidden" name="r" value="capture-lessons-edit-bquote4">
...
} else if ($_POST['r'] == 'capture-lessons-edit-bquote4'   && $_POST['crud'] == 'set') {

	$save_tbc = array(
		'id_bible_quote4' =>  $_POST['id_bible_quote4'],
		'bible_quote4' =>  $_POST['bible_quote4'],
