<?php
if ($_POST['r'] == 'capture-lessons-add-quote3'   && !isset($_POST['crud'])) {
	...
	printf('
		...
		<form method="POST" class="">
			<div class="">
				<input type="hidden" name="id_title_bible_quote3" value="0">
			</div>
			<div class="">
				<input type="text" name="title_bible_quote3" placeholder="cita bíblica" required>
			</div>
			<div class="">
			...
			<div class="">
				...
				<input type="hidden" name="r" value="capture-lessons-add-quote3">
				<input type="hidden" name="crud" value="set">
			</div>
		</form>
	', $name_lesson_select, $number_question_select);
} else if ($_POST['r'] == 'capture-lessons-add-quote3'   && $_POST['crud'] == 'set') {
