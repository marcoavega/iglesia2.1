...
if ($_POST['r'] == 'capture-lessons-edit-bquote5'   && !isset($_POST['crud'])) {

	$tbc = $tbc_controller->get5($_POST['id_bible_quote5']);
	...
	if (empty($tbc)) {
		...
		printf($template, $_POST['bible_quote5']);
	} else {
		...
		$template_tbc = '
			...
			<form method="POST" class="">
				<div class="">
					<input type="text" placeholder="id_bible_quote5" value="%s" disabled required>
					<input type="hidden" name="id_bible_quote5" value="%s">
				</div>
				<div class="">
					<input type="text" name="bible_quote5" placeholder="Objetivos" value="%s" required>
				</div>
				<div class="">
				...
				<div class="p_25">
					...
					<input type="hidden" name="r" value="capture-lessons-edit-bquote5">
...
} else if ($_POST['r'] == 'capture-lessons-edit-bquote5'   && $_POST['crud'] == 'set') {

	$save_tbc = array(
		'id_bible_quote5' =>  $_POST['id_bible_quote5'],
		'bible_quote5' =>  $_POST['bible_quote5'],
