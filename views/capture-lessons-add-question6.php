<?php
if ($_POST['r'] == 'capture-lessons-add-question6'   && !isset($_POST['crud'])) {
	...
	printf('
		...
		<form method="POST" class="">
			<div class="">
				<input type="hidden" name="id_question6" value="0">
			</div>
			<div class="">
				<input type="text" name="question6" placeholder="Pregunta" required>
			</div>
			<div class="">
			...
			<div class="">
				...
				<input type="hidden" name="r" value="capture-lessons-add-question6">
				<input type="hidden" name="crud" value="set">
			</div>
		</form>
	', $name_lesson_select);
} else if ($_POST['r'] == 'capture-lessons-add-question6'   && $_POST['crud'] == 'set') {
	...
	$brc = $brc_controller->set6($newtvc);
