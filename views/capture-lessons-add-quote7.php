<?php
if ($_POST['r'] == 'capture-lessons-add-quote7'   && !isset($_POST['crud'])) {
	...
	printf('
		<h2 class="">Agregar cita bíblica 7</h2>
		<form method="POST" class="">
			<div class="">
				<input type="hidden" name="id_title_bible_quote7" value="0">
			</div>
			<div class="">
				<input type="text" name="title_bible_quote7" placeholder="cita bíblica" required>
			</div>
			<div class="">
			...
			<div class="">
				...
				<input type="hidden" name="r" value="capture-lessons-add-quote7">
				<input type="hidden" name="crud" value="set">
			</div>
		</form>
	', $name_lesson_select, $number_question_select);
} else if ($_POST['r'] == 'capture-lessons-add-quote7'   && $_POST['crud'] == 'set') {
	...
	$tbc = $tbc_controller->set7($newtvc);
