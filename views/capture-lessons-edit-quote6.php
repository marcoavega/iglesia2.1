...
if ($_POST['r'] == 'capture-lessons-edit-quote6'   && !isset($_POST['crud'])) {

	$tbc = $tbc_controller->get6($_POST['id_title_bible_quote6']);
	...
	if (empty($tbc)) {
		...
		printf($template, $_POST['title_bible_quote6']);
	} else {
		...
		$template_tbc = '
			...
			<form method="POST" class="">
				<div class="">
					<input type="text" placeholder="id_title_bible_quote6" value="%s" disabled required>
					<input type="hidden" name="id_title_bible_quote6" value="%s">
				</div>
				<div class="">
					<input type="text" name="title_bible_quote6" placeholder="Objetivos" value="%s" required>
				</div>
				<div class="">
				...
				<div class="p_25">
					...
					<input type="hidden" name="r" value="capture-lessons-edit-quote6">
		...
		printf(
			$template_tbc,
			$tbc[0]['id_title_bible_quote6'],
			$tbc[0]['id_title_bible_quote6'],
			$tbc[0]['title_bible_quote6'],
			$name_lesson_select,
			$number_question_select
		);
	}
} else if ($_POST['r'] == 'capture-lessons-edit-quote6'   && $_POST['crud'] == 'set') {

	$save_tbc = array(
		'id_title_bible_quote6' =>  $_POST['id_title_bible_quote6'],
		'title_bible_quote6' =>  $_POST['title_bible_quote6'],
		'name_lesson' =>  $_POST['name_lesson'],
		'number_question' =>  $_POST['number_question'],
	);

	$tbc = $tbc_controller->set6($save_tbc);
