...
if ($_POST['r'] == 'capture-lessons-edit-bquote1'   && !isset($_POST['crud'])) {

	$tbc = $tbc_controller->get1($_POST['id_bible_quote1']);
	...
	if (empty($tbc)) {
		...
		printf($template, $_POST['bible_quote1']);
	} else {
		...
		$template_tbc = '
			...
			<form method="POST" class="">
				<div class="">
					<input type="text" placeholder="id_bible_quote1" value="%s" disabled required>
					<input type="hidden" name="id_bible_quote1" value="%s">
				</div>
				<div class="">
					<input type="text" name="bible_quote1" placeholder="Objetivos" value="%s" required>
				</div>
				<div class="">
				...
				<div class="p_25">
					...
					<input type="hidden" name="r" value="capture-lessons-edit-bquote1">
...
} else if ($_POST['r'] == 'capture-lessons-edit-bquote1'   && $_POST['crud'] == 'set') {

	$save_tbc = array(
		'id_bible_quote1' =>  $_POST['id_bible_quote1'],
		'bible_quote1' =>  $_POST['bible_quote1'],
