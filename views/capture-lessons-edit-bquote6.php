...
if ($_POST['r'] == 'capture-lessons-edit-bquote6'   && !isset($_POST['crud'])) {

	$tbc = $tbc_controller->get6($_POST['id_bible_quote6']);
	...
	if (empty($tbc)) {
		...
		printf($template, $_POST['bible_quote6']);
	} else {
		...
		$template_tbc = '
			...
			<form method="POST" class="">
				<div class="">
					<input type="text" placeholder="id_bible_quote6" value="%s" disabled required>
					<input type="hidden" name="id_bible_quote6" value="%s">
				</div>
				<div class="">
					<input type="text" name="bible_quote6" placeholder="Objetivos" value="%s" required>
				</div>
				<div class="">
				...
				<div class="p_26">
					...
					<input type="hidden" name="r" value="capture-lessons-edit-bquote6">
...
} else if ($_POST['r'] == 'capture-lessons-edit-bquote6'   && $_POST['crud'] == 'set') {

	$save_tbc = array(
		'id_bible_quote6' =>  $_POST['id_bible_quote6'],
		'bible_quote6' =>  $_POST['bible_quote6'],
