<?php
if ($_POST['r'] == 'capture-lessons-add-bquote8'   && !isset($_POST['crud'])) {
	...
	printf('
		...
		<form method="POST" class="">
			<div class="">
				<input type="hidden" name="id_bible_quote8" value="0">
			</div>
			<div class="">
				<textarea name="bible_quote8" rows="10" cols="40" placeholder="Citas" required></textarea>
			</div>
			<div class="">
			...
			<div class="">
				...
				<input type="hidden" name="r" value="capture-lessons-add-bquote8">
				<input type="hidden" name="crud" value="set">
			</div>
		</form>
	', $name_lesson_select, $number_question_select);
} else if ($_POST['r'] == 'capture-lessons-add-bquote8'   && $_POST['crud'] == 'set') {
