<?php
if ($_POST['r'] == 'capture-lessons-add-quote2'   && !isset($_POST['crud'])) {
	...
	printf('
		<h2 class="">Agregar cita bíblica 2</h2>
		<form method="POST" class="">
			<div class="">
				<input type="hidden" name="id_title_bible_quote2" value="0">
			</div>
			<div class="">
			<textarea name="title_bible_quote2" rows="10" cols="40" placeholder="Citas" required></textarea>
			</div>
			<div class="">
			...
			<div class="">
				...
				<input type="hidden" name="r" value="capture-lessons-add-quote2">
				<input type="hidden" name="crud" value="set">
			</div>
		</form>
	', $name_lesson_select, $number_question_select);
} else if ($_POST['r'] == 'capture-lessons-add-quote2'   && $_POST['crud'] == 'set') {
	...
	$tbc = $tbc_controller->set2($newtvc);
