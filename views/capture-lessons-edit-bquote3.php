...
if ($_POST['r'] == 'capture-lessons-edit-bquote3'   && !isset($_POST['crud'])) {

	$tbc = $tbc_controller->get3($_POST['id_bible_quote3']);
	...
	if (empty($tbc)) {
		...
		printf($template, $_POST['bible_quote3']);
	} else {
		...
		$template_tbc = '
			...
			<form method="POST" class="">
				<div class="">
					<input type="text" placeholder="id_bible_quote3" value="%s" disabled required>
					<input type="hidden" name="id_bible_quote3" value="%s">
				</div>
				<div class="">
					<input type="text" name="bible_quote3" placeholder="Objetivos" value="%s" required>
				</div>
				<div class="">
				...
				<div class="p_25">
					...
					<input type="hidden" name="r" value="capture-lessons-edit-bquote3">
...
} else if ($_POST['r'] == 'capture-lessons-edit-bquote3'   && $_POST['crud'] == 'set') {
