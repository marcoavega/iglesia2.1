<?php
if ($_POST['r'] == 'capture-lessons-add-quote5'   && !isset($_POST['crud'])) {
	...
	printf('
		<h2 class="">Agregar cita bíblica 5</h2>
		<form method="POST" class="">
			<div class="">
				<input type="hidden" name="id_title_bible_quote5" value="0">
			</div>
			<div class="">
				<input type="text" name="title_bible_quote5" placeholder="cita bíblica" required>
			</div>
			<div class="">
			...
			<div class="">
				...
				<input type="hidden" name="r" value="capture-lessons-add-quote5">
				<input type="hidden" name="crud" value="set">
			</div>
		</form>
	', $name_lesson_select, $number_question_select);
} else if ($_POST['r'] == 'capture-lessons-add-quote5'   && $_POST['crud'] == 'set') {
	...
	$tbc = $tbc_controller->set5($newtvc);
