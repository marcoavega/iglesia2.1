...
if ($_POST['r'] == 'capture-lessons-edit-bquote2'   && !isset($_POST['crud'])) {

	$tbc = $tbc_controller->get2($_POST['id_bible_quote2']);
	...
	if (empty($tbc)) {
		...
		printf($template, $_POST['bible_quote2']);
	} else {
		...
		$template_tbc = '
			...
			<form method="POST" class="">
				<div class="">
					<input type="text" placeholder="id_bible_quote2" value="%s" disabled required>
					<input type="hidden" name="id_bible_quote2" value="%s">
				</div>
				<div class="">
					<input type="text" name="bible_quote2" placeholder="Objetivos" value="%s" required>
				</div>
				<div class="">
				...
				<div class="p_25">
					...
					<input type="hidden" name="r" value="capture-lessons-edit-bquote2">
...
} else if ($_POST['r'] == 'capture-lessons-edit-bquote2'   && $_POST['crud'] == 'set') {

	$save_tbc = array(
		'id_bible_quote2' =>  $_POST['id_bible_quote2'],
		'bible_quote2' =>  $_POST['bible_quote2'],
