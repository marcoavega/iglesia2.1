...
if (isset($_POST["btnguardar"])) {
  $con = connect();
  $nombres = $_POST['id_himno'];
  $celular = $_POST['pagina_0'];
                ...
                <form id="frmLogin" action="" method="post">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" name="apenom"
                                placeholder="Ingrese Apellidos y nombres" value="">
                        </div>
                        <div class="form-group">
                            <label for="celular">Celular:</label>
                            <input required class="form-control" type="text" name="celular"
                                placeholder="Ingrese celular" value="">
                        </div>

                        <div class="form-group">
                            <label for="email">E-Mail:</label>
                            <input required class="form-control" type="email" name="email" placeholder="Ingrese E-mail"
                                value="">
                        </div>
